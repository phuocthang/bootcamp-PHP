        ...
        <div class="row choice_inner">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="choice_item">
                        <img class="img-fluid" src="{{ asset('storage/images/'.$blogs->image) }}" alt="">
                        <div class="choice_text">
                            <div class="date">
                                <a class="gad_btn" href="#">tin </a>
                            <a href="#"><i class="fa fa-calendar" aria-hidden="true"></i>{{ date("m-d-Y") }}</a>
                                <a href="#"><i class="fa fa-comments-o" aria-hidden="true"></i>05</a>
                            </div>
                            <a href="{{ route('chitiet',$blogs->id) }}"><h4>{{ $blogs->titleBlog }}</h4></a>
                            <p>{{ $blogs->contentBlog }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
